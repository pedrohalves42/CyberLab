...
mkdir -p "$BASE/modules/scan" "$BASE/results/web" "$BASE/logs"

cat > "$BASE/modules/scan/scan-engine.sh" <<'SCRIPT'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x "$BASE/modules/scan/scan-engine.sh"
