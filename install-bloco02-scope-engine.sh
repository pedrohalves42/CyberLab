...
cat > "$BASE/modules/scope/scope.sh" <<'SCRIPT'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x "$BASE/modules/scope/scope.sh"
...
echo
echo "[OK] BLOCO 02 Scope Engine instalado"
echo
echo "Fluxo de teste:"
echo
...
echo
echo "cyberlab scope show"
echo "cyberlab scope check lojamaromba.com"
echo "cyberlab scope check api.lojamaromba.com"
echo "cyberlab scope check evil.com"
echo "cyberlab scope deny test.lojamaromba.com"
echo "cyberlab scope allow-ip 172.16.0.0/24"
