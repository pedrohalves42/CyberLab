...
# === CYBERLAB_BLOCK15_SAFE_URL_HELPER ===
def cyberlab_safe_url(value):
    if value is None:
        return None
    ...
    return url
# === END_CYBERLAB_BLOCK15_SAFE_URL_HELPER ===
...
class ControlledHttpClient:
    ...
    def request(
        ...
        # === CYBERLAB_BLOCK15_REQUEST_URL_GUARD ===
        safe_url = cyberlab_safe_url(url)
        if not safe_url:
            return SafeHttpResult(
                ...
                content_length=None,
                body_sample="",
                error="invalid_url_filtered_by_cyberlab",
                elapsed_ms=0,
            )
        url = safe_url
        # === END_CYBERLAB_BLOCK15_REQUEST_URL_GUARD ===
